...
func (CoaCowTrans) TableName() string {
	return "t_coa_cow_trans"
}

type CoaCowTrans struct {
	baseapp.BaseModel
	...
	CoaCowTransItem               []CoaCowTransItem `gorm:"foreignKey:TCoaCowTransId; constraint:OnDelete:CASCADE" json:"items"`
}

func (CoaCowTransItem) TableName() string {
	return "t_coa_cow_trans_item"
}

type CoaCowTransItem struct {
	baseapp.BaseModel
